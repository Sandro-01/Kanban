  ...
  if (!metrics) {
    return (
      <div className="page sla-page">
        ...
        <div className="card">
          <p>Unable to load SLA metrics. Make sure the backend is running.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page sla-page">
      ...
      <div className="alert alert-info">
        <strong>ISO 9001 Compliance:</strong> SLA tracking ensures response times conform to defined quality standards.
      </div>
      ...
      <div className="sla-overview-cards">
        ...
        <div className="sla-overview-card warning">
          ...
          <div className="card-content">
            ...
            <div className="card-label">Near Deadline</div>
          </div>
        </div>
      ...
      {violations.length === 0 && (
        <div className="card success-message">
          ...
          <p>All tickets are being handled within the expected time!</p>
        </div>
      )}
    </div>
  );
